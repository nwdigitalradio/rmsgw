...
NEW_SERVICE_FILES="winlinkservice.xml .version_info ../etc/hosts getsysop.py getchannel.py updatechannel.py  updatesysop.py updateversion.py getversionlist.py versionlist.sh"
